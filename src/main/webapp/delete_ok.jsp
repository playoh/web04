<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="org.example.ihateweb04.dao.BoardDAO, org.example.ihateweb04.bean.BoardVO, java.io.File" %>
...
<%
    ...
    if (sid != null && !sid.isEmpty()) {
        try {
            ...
            if (u == null || u.getTitle() == null) { // 유효하지 않은 데이터인 경우
                u = null;
            }
